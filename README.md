...
System will keep checking for any of the sensors go high in continuous while loop.
...
**Creating pic/video file name with date and time**
```
...
```
**video recording for 40 seconds**
```
